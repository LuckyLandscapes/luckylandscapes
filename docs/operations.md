...
- **Insurance / certs:** **Bound (confirmed 2026-06-21): $1,000,000 general liability + workers' compensation.** Have LLC + EIN. Keep the COIs on file (the `/contractors` lane offers COI-on-request) and enter the actual WC rate per $100 of payroll into /team → Payroll Settings (replaces the 5% placeholder used for job-cost previews). Because coverage is in force, the site-wide "Fully Insured" claim is accurate — do not strip it.
...
1. **Workers' comp — RESOLVED (2026-06-21).** A workers' compensation policy is now bound (alongside $1,000,000 general liability), satisfying Nebraska Workers' Comp Act §48-115. Keep the policy current and the COI on file; enter the real WC rate per $100 of payroll in /team → Payroll Settings so job-cost previews stop using the 5% placeholder.
