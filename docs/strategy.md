# Strategy — Goals, constraints, and the right next move

> **Update cadence:** revisit at the start of each season, after any major win/loss, or whenever priorities shift. This file decays fast — stale strategy is worse than none.

## North star (3-year)
Where does Lucky Landscapes want to be in 3 years?
...
- TODO: e.g. "Should hardscaping become 50% of revenue or stay an upsell?"
- TODO: e.g. "Is the design service worth keeping if it's not a profit center directly?"
- TODO: e.g. "Should we hire a second crew lead this year or wait?"
- TODO: e.g. "Is the luckyapp investment paying back, or are we over-engineering?"

## Decisions log
Record big calls so future-you (and Claude) understand the *why* behind the current state.
