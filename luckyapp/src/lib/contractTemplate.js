...
export function renderContractBody({
  ...
  return [
    ...
    depositLine,
    'Accepted payment methods include credit/debit card, ACH bank transfer, check, and cash. Past-due balances accrue interest at 1% per month (18% APR). Customer is responsible for reasonable collection costs and attorneys\' fees if collection becomes necessary.',
    '',
    '3. SCHEDULE',
